...
if ($_REQUEST['status'] === 'pending' &&
    ...
    $detalle = "Se genergó el cupón de pago. Siga las instrucciones enviadas a su email para finalizar la compra.
 Código Mercado Pago:</strong> {$_REQUEST['payment_id']}";
}
 ...
 * SUCCESS post;
 * Array (
 * [preference_id] => 469485398-55f4dc4f-30e7-4cf4-8d2c-c7b223f5503e
 * [external_reference] => marcos.botta@gmail.com
 * [back_url] =>
 * [payment_id] => 13434724908
 * [payment_status] => approved
 * [payment_status_detail] => accredited
 * [merchant_order_id] => 2285985386
 * [processing_mode] => aggregator
 * [merchant_account_id] => ) Array ( ) Array (
 *          [preference_id] => 469485398-55f4dc4f-30e7-4cf4-8d2c-c7b223f5503e
 *          [external_reference] => marcos.botta@gmail.com
 *          [back_url] =>
 *          [payment_id] => 13434724908
                                    ...
                                    <div class="as-producttile-title">
                                        <h3 class="as-producttile-name">
                                            <p class="as-producttile-tilelink">
                                                <span data-ase-truncate="2"><?php echo $detalle; ?></span>
                                            </p>
